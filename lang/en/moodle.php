...
$string['activities_help'] = 'Activities, such as forums, quizzes and wikis, enable interactive content to be added to the area.';
...
$string['addcreator'] = 'Add area creator';
$string['adddots'] = 'Add...';
$string['added'] = 'Added {$a}';
$string['addedtogroup'] = 'Added to group "{$a}"';
$string['addedtogroupnot'] = 'Not added to group "{$a}"';
$string['addedtogroupnotenrolled'] = 'Not added to group "{$a}", because not enrolled in area';
...
$string['addnewcourse'] = 'Add a new area';
...
$string['addstudent'] = 'Add employee';
...
$string['adminhelpassigncreators'] = 'Area creators can create new areas';
$string['adminhelpassignsiteroles'] = 'Apply defined site roles to specific users';
$string['adminhelpassignstudents'] = 'Go into a area and add employees from the admin menu';
...
$string['adminhelpcourses'] = 'Define areas and categories and assign people to them, edit pending areas';
$string['adminhelpeditor
settings'] = 'Define basic settings for HTML editor';
...
$string['administratordescription'] = 'Administrators can usually do anything on the site, in all areas.';
...
$string['allowstealthmodules_help'] = 'If enabled, activities can be made available but not shown in visible sections of the area page. If so, links to stealth activities must be provided from elsewhere, such as from a page resource. Stealth activities are still listed in the gradebook and other reports.';
$string['allownone'] = 'Allow none';
$string['allownot'] = 'Do not allow';
$string['allparticipants'] = 'All employees';
...
$string['areyousuretorestorethisinfo'] = 'Later in this process you will have a choice of adding this backup to an existing area or creating a completely new area.';
...
$string['availablecourses'] = 'Available areas';
$string['back'] = 'Back';
$string['backto'] = 'Back to {$a}';
$string['backtocourselisting'] = 'Back to area listing';
...
$string['backupadhocpending'] = 'Area backup ad hoc task pending';
$string['backupcancelled'] = 'Backup cancelled';
$string['backupcoursefileshelp'] = 'If enabled then area files will be included in automated backups';
...
$string['backupfailed'] = 'Some of your areas weren\'t saved!!';
...
$string['backupincludemoduleshelp'] = 'Choose whether you want to include area modules, with or without user data, in automated backups';
...
$string['backupsitefileshelp'] = 'If enabled then site files used in areas will be included in automated backups';
...
$string['bulkmovecoursessuccess'] = 'Successfully moved {$a->courses} areas into {$a->category}';
$string['bulkselection'] = '{$a} selected';
$string['bycourseorder'] = 'By area order';
$string['byname'] = 'by {$a}';
...
$string['categories'] = 'Area categories';
$string['categoriesandcourses'] = 'Area categories and areas';
$string['category'] = 'Category';
$string['categoryadded'] = 'The category \'{$a}\' was added';
$string['categorybulkaction'] = 'Bulk actions for selected categories';
$string['categorycontents'] = 'Subcategories and areas';
...
$string['idnumbercoursecategory_help'] = 'The ID number of a area category  is only used when matching the category against external systems and is not displayed anywhere on the site. If the category has an official code name it may be entered, otherwise the field can be left blank.';
...
$string['closecourseindex'] = 'Close area index';
...
$string['confirmcoursemove'] = 'Are you sure you want to move this area ({$a->course}) into this category ({$a->category})?';
$string['considereddigitalminor'] = 'You are too young to create an account on this site.';
$string['content'] = 'Content';
$string['contentexport_aboutthiscourse'] = 'Area summary';
...
$string['continuetocourse'] = 'Click here to enter your area';
...
$string['copycourse'] = 'Copy area';
$string['copyingcoursefiles'] = 'Copying area files';
$string['copyingsitefiles'] = 'Copying site files used in area';
...
$string['course'] = 'area';
$string['courseheader'] = 'Area menu';
$string['courseadministration'] = 'Area administration';
$string['courseapprovedemail'] = 'Your requested area, {$a->name}, has been approved and you have been made a {$a->teacher}.  To access your new course, go to {$a->url}';
$string['courseapprovedemail2'] = 'Your requested area, {$a->name}, has been approved.  To access your new area, go to {$a->url}';
$string['courseapprovedfailed'] = 'Failed to save the area as approved!';
$string['courseapprovedsubject'] = 'Your area has been approved!';
$string['courseavailable'] = 'This area is available to empoyees';
$string['courseavailablenot'] = 'This area is not available to employees';
$string['coursebackup'] = 'Area backup';
$string['coursebulkaction'] = 'Bulk actions for selected areas';
$string['coursecategories'] = 'Area categories';
$string['coursecategory'] = 'Area category';
$string['coursecategory_help'] = 'This setting determines the category in which the area will appear in the list of areas.';
$string['coursecategorydeleted'] = 'Deleted area category {$a}';
$string['coursecatmanagement'] = 'Area and category management';
$string['coursecompletion'] = 'Area completion';
$string['coursecompletions'] = 'Area completions';
$string['coursecreators'] = 'Area creator';
$string['coursecreatorsdescription'] = 'Area creators can create new areas.';
$string['coursedetails'] = 'Area details';
$string['coursedisplay'] = 'Area layout';
$string['coursedisplay_help'] = 'Area sections can be displayed all in one page or split over several pages.';
$string['coursedisplay_single'] = 'Show all sections on one page';
$string['coursedisplay_multi'] = 'Show one section per page';
$string['coursedeleted'] = 'Deleted area {$a}';
$string['courseextendednamedisplay'] = '{$a->shortname} {$a->fullname}';
$string['coursefiles'] = 'Legacy area files';
$string['coursefilesedit'] = 'Edit legacy area files';
$string['coursefileswarning'] = 'Area files are deprecated';
$string['coursefileswarning_help'] = 'Area files are deprecated since Moodle 2.0, please use external repositories instead as much as possible.';
$string['courseformatdata'] = 'Area format data';
$string['courseformats'] = 'Area formats';
$string['courseformatoptions'] = 'Formatting options for {$a}';
$string['courseformatudpate'] = 'Update format';
$string['courseprofiles'] = 'Area profiles';
$string['coursegrades'] = 'Area grades';
$string['coursehelpcategory'] = 'Position the area on the area listing and may make it easier for employees to find it.';
$string['coursehelpforce'] = 'Force the area group mode to every activity in the area.';
$string['coursehelpformat'] = 'The area main page will be displayed in this format.';
$string['coursehelphiddensections'] = 'How the hidden sections in the area are displayed to employees.';
$string['coursehelpmaximumupload'] = 'Define the largest size of file that can be uploaded in this area, limited by the site-wide setting.';
$string['coursehelpnewsitemsnumber'] = 'Number of recent announcements appearing in the latest announcements block on the area page. If set to zero, the announcements forum will not be created.';
$string['coursehelpnumberweeks'] = 'Number of sections in the area (applies to certain area formats only).';
$string['coursehelpshowgrades'] = 'Enable the display of the gradebook. It does not prevent grades from being displayed within the individual activities.';
$string['coursehidden'] = 'This area is currently unavailable to employees';
$string['courseoverviewfiles'] = 'Area image';
$string['courseoverviewfilesext'] = 'Area image file extensions';
$string['courseoverviewfileslimit'] = 'Area image files limit';
$string['courseoverviewfiles_help'] = 'The area image is displayed in My areas and in the list of available areas on the Home page. Site administrators can enable additional file types and the use of multiple files. If you use multiple files, they will all be displayed in the list of available areas in the Home page.';
$string['courseinfo'] = 'Area info';
$string['coursenotaccessible'] = 'This area does not allow public access';
$string['courselegacyfiles'] = 'Legacy area files';
$string['courselegacyfiles_help'] = 'The area files area provides some backward compatibility with Moodle 1.9 and earlier.  All files in this area are always accessible to all employees in the area (whether you link to them or not) and there is no way to know where any of these files are being used in Moodle.

If you use this area to store area files, you can expose yourself to a number of privacy and security issues, as well as experiencing missing files in backups, area imports and any time content is shared or re-used.  It is therefore recommended that you do not use this area unless you really know what you are doing.';
$string['courselegacyfiles_link'] = 'areafiles2';
$string['courselegacyfilesofcourse'] = 'Legacy area files: {$a}';
$string['courseoverview'] = 'Area overview';
$string['courseoverviewgraph'] = 'Area overview graph';
...
$string['coursereject'] = 'Reject a area request';
$string['courserejected'] = 'Area has been rejected and the requester has been notified.';
$string['courserejectemail'] = 'Sorry, but the area you requested has been rejected. Here is the reason provided:

{$a}';
$string['courserejectreason'] = 'Outline your reasons for rejecting this area<br />(this will be emailed to the requester)';
$string['courserejectsubject'] = 'Your area has been rejected';
$string['coursereport'] = 'Area report';
$string['coursereports'] = 'Area reports';
$string['courserequest'] = 'Area request';
$string['courserequestdetails'] = 'Details of the area you are requesting';
$string['courserequestfailed'] = 'For some reason, your area request could not be saved';
$string['courserequestintro'] = 'Use this form to request a area to be created for you.<br />Try and fill in as much information as you can to allow<br />the administrators to understand your reasons for wanting this area.';
$string['courserequestreason'] = 'Reasons for wanting this area';
$string['courserequestroleerror'] = 'The creators\' role in new areas configuration is invalid. Please see <a href="{$a}">user policies</a>.';
$string['courserequestsuccess'] = 'Area request submitted.';
$string['courserequestsupport'] = 'Supporting information to help the administrator evaluate this request';
$string['courserequestwarning'] = 'The user requesting this area will be automatically enrolled and assigned the role of {$a}.';
$string['courserestore'] = 'Area restore';
$string['coursereuse'] = 'Area reuse';
$string['courses'] = 'areas';
$string['coursesectionsummaries'] = 'Area section summaries';
...
$string['coursesettings'] = 'Area default settings';
$string['coursesmovedout'] = 'areas moved out from {$a}';
$string['coursespending'] = 'areas pending approval';
$string['coursesearch'] = 'Search areas';
...
$string['coursestart'] = 'Area start';
$string['coursesummary'] = 'Area summary';
$string['coursesummary_help'] = 'A short description of your area. The content you add here is searchable.';
$string['coursetitle'] = 'area: {$a->course}';
$string['coursetitlebulkediting'] = 'Bulk edit area: {$a->course}';
$string['coursetitleediting'] = 'Edit area: {$a->course}';
$string['courseupdates'] = 'Area updates';
$string['coursevisibility'] = 'Area visibility';
$string['coursevisibility_help'] = '* Show: The area appears in the list of areas and employees can access it.
* Hide: Access is restricted to teachers and other users with the capability to view hidden areas.';
...
$string['createnewcourse'] = 'Create new area';
...
$string['creatingcoursemodules'] = 'Creating area modules';
$string['creatingcourseroles'] = 'Creating area level role assignments and overrides';
...
$string['creatingnewcourse'] = 'Creating new area';
...
$string['currentcourse'] = 'Current area';
$string['currentcourseadding'] = 'Current area, adding data to it';
$string['currentcoursedeleting'] = 'Current area, deleting it first';
...
$string['defaultcoursestudent'] = 'Employee';
$string['defaultcoursestudentdescription'] = 'Employees generally have fewer privileges within a area.';
$string['defaultcoursestudents'] = 'Employees';
$string['defaultcoursesummary'] = 'Write a concise and interesting paragraph here that explains what this area is about';
$string['defaultcourseteacher'] = 'Teacher';
$string['defaultcourseteacherdescription'] = 'Teachers can do anything within a area, including changing the activities and grading employees.';
...
$string['deletecategorycheck'] = 'Are you absolutely sure you want to completely delete this category <b>\'{$a}\'</b>?<br />This will move all areas into the parent category if there is one, or into Miscellaneous.';
$string['deletecategorycheck2'] = 'If you delete this category, you need to choose what to do with the areas and subcategories it contains.';
$string['deletecommentbyon'] = 'Delete comment posted by {$a->user} on {$a->time}';
$string['deletecompletely'] = 'Delete completely';
$string['deletecourse'] = 'Delete a area';
$string['deletecoursecheck'] = 'Are you absolutely sure you want to completely delete this area and all the data it contains?';
...
$string['deletingexistingcoursedata'] = 'Deleting existing area data';
...
$string['dndcourse'] = 'You can drag and drop this area to alter its sorting or to move it to another category.';
...
$string['dndworkingfiletextlink'] = 'Drag and drop files, text or links onto area sections to upload them';
$string['dndworkingfilelink'] = 'Drag and drop files or links onto area sections to upload them';
$string['dndworkingfiletext'] = 'Drag and drop files or text onto area sections to upload them';
$string['dndworkingfile'] = 'Drag and drop files onto area sections to upload them';
$string['dndworkingtextlink'] = 'Drag and drop text or links onto area sections to upload them';
$string['dndworkingtext'] = 'Drag and drop text onto area sections to upload it';
$string['dndworkinglink'] = 'Drag and drop links onto area sections to upload them';
$string['documentation'] = 'Moodle documentation';
$string['dontsortcategories'] = 'Don\'t sort categories';
$string['dontsortcourses'] = 'Don\'t sort areas';
$string['down'] = 'Down';
...
$string['editcoursesettings'] = 'Edit area settings';
...
* Participating - actions performed by a employee, e.g. posting in a forum
* Other - actions performed by a user with a role other than teacher or employee';
...
* Visible to area employees - Only employees of areas you are enrolled in can view your email address.';
$string['emaildisplaycourse'] = 'Visible to area employees';
$string['emaildisplaycoursemembersonly'] = '(Visible to other area employees)';
...
$string['emptycmids'] = 'Empty area module IDs';
$string['emptydragdropregion'] = 'empty region';
$string['emptysectionids'] = 'Empty section IDs';
$string['enable'] = 'Enable';
$string['encryptedcode'] = 'Encrypted code';
$string['enddate'] = 'Area end date';
$string['enddate_help'] = 'The end date doesn’t restrict employee access to the area. It determines whether a area is listed as Past in My areas.';
$string['enddatewithtaskenabled'] = 'Area end date';
$string['enddatewithtaskenabled_help'] = 'The date when the area becomes hidden for employees and they can no longer access it.';
$string['english'] = 'English';
$string['enrolmentmethods'] = 'Enrolment methods';
$string['entercourse'] = 'Click to enter this area';
...
$string['eventcoursebackupcreated'] = 'Area backup created';
...
$string['eventcoursecontentdeleted'] = 'Area content deleted';
$string['eventcoursecreated'] = 'Area created';
$string['eventcoursedeleted'] = 'Area deleted';
$string['eventcourseended'] = 'Area ended';
$string['eventcourseinformationviewed'] = 'Area summary viewed';
$string['eventcoursemodulecreated'] = 'Area module created';
$string['eventcoursemoduledeleted'] = 'Area module deleted';
$string['eventcoursemoduleupdated'] = 'Area module updated';
$string['eventcoursemoduleviewed'] = 'Area module viewed';
$string['eventcoursessearched'] = 'areas searched';
$string['eventcourseresetended'] = 'Area reset ended';
$string['eventcourseresetstarted'] = 'Area reset started';
$string['eventcourserestored'] = 'Area restored';
$string['eventcoursestarted'] = 'Area started';
$string['eventcourseupdated'] = 'Area updated';
$string['eventcoursesectioncreated'] = 'Area section created';
$string['eventcoursesectiondeleted'] = 'Area section deleted';
$string['eventcoursesectionupdated'] = 'Area section updated';
$string['eventcoursemoduleinstancelistviewed'] = 'Area module instance list viewed';
$string['eventcourseuserreportviewed'] = 'Area user report viewed';
$string['eventcourseviewed'] = 'Area viewed';
...
$string['eventmycoursesviewed'] = 'My areas viewed';
...
$string['existingcourse'] = 'Existing area';
$string['existingcourseadding'] = 'Existing area, adding data to it';
$string['existingcoursedeleting'] = 'Existing area, deleting it first';
$string['existingcreators'] = 'Existing area creators';
$string['existingstudents'] = 'Enrolled employees';
...
$string['findmorecourses'] = 'Find more areas...';
$string['first'] = 'First';
...
$string['format_help'] = 'The area format determines the layout of the area page.

* Single activity format - For displaying a single activity or resource (such as a Quiz or SCORM package) on the area page
* Social format - A forum is displayed on the area page
* Topics format - The area page is organised into topic sections
* Weekly format - The area page is organised into weekly sections, with the first week starting on the area start date';
...
$string['frontpagecourselist'] = 'List of areas';
$string['frontpagecoursesearch'] = 'Area search box';
$string['frontpageenrolledcourselist'] = 'Enrolled areas';
$string['frontpagedescription'] = 'Site home summary';
$string['frontpagedescriptionhelp'] = 'This summary can be displayed on the site home using the area/site summary block.';
...
$string['fulllistofcourses'] = 'All areas';
$string['fullname'] = 'Full name'; /* @deprecated - Use fullnamearea or fullnameuser or some own context specific string. */
$string['fullnamecourse'] = 'Area full name';
$string['fullnamecourse_help'] = 'The name displayed in My areas and in the list of available areas on the Home page.';
...
$string['hiddenfromstudents'] = 'Hidden from employees';
$string['hiddenoncoursepage'] = 'Available but not shown on area page';
$string['hiddensections'] = 'Hidden sections';
$string['hiddensections_help'] = 'Hidden sections can be displayed to employees as \'not available\' on the area page, or kept completely hidden.';
...
$string['hidefromstudents'] = 'Hide on area page';
$string['hideoncoursepage'] = 'Make available but don\'t show on area page';
...
$string['checkingcourse'] = 'Checking area';
...
$string['childcoursenotfound'] = 'Child area not found!';
$string['childcourses'] = 'Child areas';
$string['choose'] = 'Choose';
$string['choosecourse'] = 'Choose a area';
...
$string['courseduration'] = 'Area duration';
$string['courseduration_desc'] = 'The area duration is used to calculate the default area end date. The area end date is used for determining whether a area should be included in a user\'s list of areas.  It may also be used by custom reports. Users can still enter the area after the end date.';
$string['courseenddateenabled'] = 'Area end date enabled by default';
$string['courseenddateenabled_desc'] = 'This setting determines if the area end date will be enabled by default for new areas and set to the date calculated from the area duration.';
...
$string['idnumbercourse'] = 'Area ID number';
$string['idnumbercourse_help'] = 'Only used to connect the area with external systems. Leave blank if you don\'t have an official area ID.';
...
$string['importdata'] = 'Import area data';
$string['importdataexported'] = 'Exported data from \'from\' area successfully.<br /> Continue to import into your \'to\' area.';
$string['importdatafinished'] = 'Import complete! Continue to your area';
$string['importdatafrom'] = 'Find a area to import data from:';
$string['inactive'] = 'Inactive';
$string['include'] = 'Include';
$string['includeallusers'] = 'Include all users';
$string['includecoursefiles'] = 'Include area files';
$string['includecourseusers'] = 'Include area users';
...
$string['includesitefiles'] = 'Include site files used in this area';
...
$string['indicator:accessesafterend'] = 'Area accessed after end date';
$string['indicator:accessesafterend_help'] = 'This indicator reflects if the employee accessed the area after the area end date.';
$string['indicator:accessesbeforestart'] = 'Area accessed before start date';
$string['indicator:accessesbeforestart_help'] = 'This indicator reflects if the employee accessed the area before the area start date.';
$string['indicator:activitiesdue'] = 'Activities due';
$string['indicator:activitiesdue_help'] = 'The user has activities due.';
$string['indicator:anycourseaccess'] = 'Any area access';
$string['indicator:anycourseaccess_help'] = 'This indicator reflects access to any area that the user is enrolled in.';
$string['indicator:anywrite'] = 'Any write action';
$string['indicator:anywrite_help'] = 'This indicator represents any write (submit) action taken by the employee.';
$string['indicator:anywriteincourse'] = 'Any write action in the area';
$string['indicator:anywriteincourse_help'] = 'This indicator represents any write (submit) action taken by the employee in any area activity.';
$string['indicator:completeduserprofile'] = 'User profile is completed';
$string['indicator:completeduserprofile_help'] = 'This indicator represents that the employee has completed their user profile.';
...
$string['indicator:completionenabled_help'] = 'This indicator represents that completion tracking has been enabled for this area.';
$string['indicator:nostudent'] = 'Employee enrolments';
$string['indicator:nostudent_help'] = 'This indicator reflects the availability of employees in the area.';
$string['indicator:noteacher'] = 'Teacher availability';
$string['indicator:noteacher_help'] = 'This indicator reflects the availability of teachers in the area.';
$string['indicator:potentialcognitive'] = 'Area potential cognitive depth';
$string['indicator:potentialcognitive_help'] = 'This indicator is based on the potential cognitive depth that could be reached by a employee participating in area activities.';
$string['indicator:potentialcognitivedef'] = 'Area potential cognitive depth';
$string['indicator:potentialcognitivedef_help'] = 'The degree to which the area offers "deep" cognitive engagement, e.g. submission of work for feedback, the opportunity to review work by others, and the opportunity to revise and resubmit work.';
$string['indicator:potentialcognitivedef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:potentialsocial'] = 'Area potential social breadth';
$string['indicator:potentialsocial_help'] = 'This indicator is based on the potential social breadth that could be reached by the employee participating in area activities.';
$string['indicator:potentialsocialdef'] = 'Area potential social breadth';
$string['indicator:potentialsocialdef_help'] = 'The degree to which the area offers "broad" social engagement, interacting with other employees and with the community of practice beyond the class.';
...
$string['indicator:readactions_help'] = 'This indicator represents the number of read (view) actions taken by the employee.';
$string['indicator:userforumstracking'] = 'User is tracking forums';
$string['indicator:userforumstracking_help'] = 'This indicator represents whether or not the employee has tracking turned on in the forums.';
$string['info'] = 'Information';
$string['inprogress'] = 'In progress';
$string['insertresourceoractivitybefore'] = 'Insert an activity or resource before \'{$a->activityname}\'';
$string['institution'] = 'Institution';
$string['instudentview'] = 'in employee view';
...
$string['lastcourseaccess'] = 'Last access to area';
...
$string['listofcourses'] = 'List of areas';
...
<p>For full access to areas you\'ll need to create yourself an account.</p>
...
$string['mailstudents'] = 'Inform employees';
$string['mailteachers'] = 'Inform teachers';
$string['maincoursepage'] = 'Main area page';
...
$string['managecombined'] = 'Manage area categories and areas';
$string['managecategories'] = 'Manage area categories';
...
$string['managecourses'] = 'Manage areas';
...
$string['maxsectionslimit'] = 'Cannot create new section as it would exceed the maximum number of sections allowed for this area ({$a}).';
...
$string['maximumupload_help'] = 'The maximum file size allowed for employee uploads to the area. Additionally, you can further restrict the maximum upload size for each activity.';
$string['maxnumberweeks'] = 'Maximum number of sections';
$string['maxnumberweeks_desc'] = 'The maximum value in the number of sections drop-down menu (applies to certain area formats only).';
$string['maxnumcoursesincombo'] = 'Browse <a href="{$a->link}">{$a->numberofcourses} areas</a>.';
...
$string['memberincourse'] = 'People in the area';
...
$string['messageprovider:coursecompleted'] = 'Area completed';
$string['messageprovider:coursecontentupdated'] = 'Area content changes';
$string['messageprovider:courserequestapproved'] = 'Area creation request approval notification';
$string['messageprovider:courserequested'] = 'Area creation request notification';
$string['messageprovider:courserequestrejected'] = 'Area creation request rejection notification';
...
$string['modvisible_help'] = '* Show on area page: Available to employees (subject to any access restrictions which may be set).
* Hide on area page: Not available to employees.';
$string['modvisiblewithstealth'] = 'Availability';
$string['modvisiblewithstealth_help'] = '* Show on area page: Available to employees (subject to any access restrictions which may be set).
* Hide on area page: Not available to employees.
* Make available but don\'t show on area page: Available to employees if you provide a link. Activities will still appear in the gradebook and other reports.';
$string['modvisiblehiddensection'] = 'Availability';
$string['modvisiblehiddensection_help'] = '* Hide on area page: Not available to employees.
* Make available but don\'t show on area page: Available to employees if you provide a link. Activities will still appear in the gradebook and other reports.';
...
$string['moodlenet:deletedcourse'] = 'Deleted area';
...
$string['moodlenet:sharenoticecourse'] = 'This area is being shared with MoodleNet as a resource.';
$string['moodlenet:sharenoticepartial'] = 'The selected activities are being shared with MoodleNet as a resource.';
$string['moodlenet:sharenoticepartialactivitynumber'] = '{$a} activities will be included in the area.';
...
$string['moodlenet:shareprogressinfo'] = 'The list shows areas and activities you have shared to MoodleNet.<br>Click the resource name to view in MoodleNet.';
...
$string['movecourseto'] = 'Move area to:';
...
$string['moveselectedcoursesto'] = 'Move selected areas to...';
...
$string['nocourses'] = 'No areas';
$string['nocoursesfound'] = 'No areas were found with the words \'{$a}\'';
$string['nocoursestarttime'] = 'The area does not have a start date.';
$string['nocoursesyet'] = 'No areas in this category';
...
$string['nofilesyet'] = 'No files have been uploaded to your area yet';
...
$string['noimagesyet'] = 'No images have been uploaded to your area yet';
$string['nologsfound'] = 'No logs have been found';
$string['nomatchingusers'] = 'No users match \'{$a}\'';
$string['nomorecourses'] = 'No more matching areas could be found';
$string['nomoreidnumber'] = 'Not using an idnumber to avoid collisions';
$string['none'] = 'None';
$string['noneditingteacher'] = 'Non-editing teacher';
$string['noneditingteacherdescription'] = 'Non-editing teachers can teach in areas and grade employees, but may not alter activities.';
$string['nonstandard'] = 'Non-standard';
$string['noresultsfor'] = 'No results for "{$a}"';
$string['nopendingcourses'] = 'There are no areas pending approval';
$string['nopotentialadmins'] = 'No potential admins';
$string['nopotentialcreators'] = 'No potential area creators';
$string['nopotentialstudents'] = 'No potential employees';
...
$string['nosite'] = 'Could not find site-level area';
$string['nostudentsfound'] = 'No {$a} found';
$string['nostudentsingroup'] = 'There are no employees in this group yet';
$string['nostudentsyet'] = 'There are no employees enrolled in this area.';
$string['nosuchemail'] = 'No such email address';
$string['notavailable'] = 'Not available';
$string['notavailablecourse'] = '{$a} is not available';
$string['noteachersyet'] = 'No teachers in this area yet';
$string['noteachingupcomingcourses'] = 'Upcoming areas have no teachers or employees';
...
$string['noteuserschangednonetocourse'] = '<strong>Note:</strong> area users need to be restored when restoring user data (in activities, files or messages). This setting has been changed for you.';
...
$string['novalidcourses'] = 'No valid areas to be shown';
$string['now'] = 'now';
$string['numattempts'] = '{$a} failed login attempt(s)';
$string['numberofcourses'] = 'Number of areas';
...
$string['opendrawerindex'] = 'Open area index';
...
$string['parentcoursenotfound'] = 'Parent area not found!';
$string['parentfolder'] = 'Parent folder';
$string['participants'] = 'employees';
$string['participantslist'] = 'employees list';
...
$string['paymentrequired'] = 'This area requires a payment for entry.';
$string['payments'] = 'Payments';
$string['paymentsorry'] = 'Thank you for your payment!  Unfortunately your payment has not yet been fully processed, and you are not yet registered to enter the area "{$a->fullname}".  Please try continuing to the area in a few seconds, but if you continue to have trouble then please alert the {$a->teacher} or the site administrator';
$string['paymentthanks'] = 'Thank you for your payment!  You are now enrolled in your area:<br />"{$a}"';
...
$string['potentialcreators'] = 'Potential area creators';
$string['potentialstudents'] = 'Potential employees';
...
$string['privacy:metadata:log:course'] = 'area';
...
$string['privacy:metadata:moodlenet_share_progress:courseid'] = 'The associated area ID';
$string['privacy:metadata:moodlenet_share_progress:cmid'] = 'The associated area module ID';
...
$string['profilenotshown'] = 'This profile description will not be shown until this person is enrolled in at least one area.';
...
$string['relativedatesmode_help'] = 'Display area or activity dates relative to the user\'s start date in the area.

The user\'s area start date will be their enrolment start date, unless they are enrolled before the area begins in which case their start date will be the area start date.

WARNING: This is an experimental feature and not all activities may support it. Once the area has been created, this area setting can no longer be changed.';
$string['relativedatesmode_warning'] = '<strong>Warning:</strong> Relative dates mode cannot be changed once the area has been created.';
$string['reload'] = 'Reload';
$string['remoteappuser'] = 'Remote {$a} User';
$string['remove'] = 'Remove';
$string['removeadmin'] = 'Remove admin';
$string['removecreator'] = 'Remove area creator';
$string['removestudent'] = 'Remove employee';
...
$string['requestcourse'] = 'Request a area';
$string['requestedby'] = 'Requested by';
$string['requestedcourses'] = 'Requested areas';
$string['requestreason'] = 'Reason for area request';
$string['requests'] = 'Requests';
$string['required'] = 'Required';
$string['requirespayment'] = 'This area requires payment for access';
$string['resendemail'] = 'Resend email';
$string['reset'] = 'Reset';
$string['resetcomponent'] = 'Component';
$string['resetcourse'] = 'Reset area';
$string['resetinfo'] = 'This page allows you to empty a area of user data, while retaining the activities and other settings.  Please be warned that by choosing items below and submitting this page you will delete your chosen user data from this area forever!';
...
$string['resortcourses'] = 'Sort areas';
...
$string['resources_help'] = 'Resource types enable almost any kind of web content to be inserted into the area.';
...
$string['restorecoursenow'] = 'Restore this area now!';
...
$string['rolerenaming_help'] = 'Change the display names of roles in this area.';
$string['rolerenaming_success'] = 'Area role names updated.';
$string['roles'] = 'Roles';
$string['rss'] = 'RSS';
...
$string['savechangesandreturntocourse'] = 'Save and return to area';
...
$string['scalestandard_help'] = 'A standard scale is available site-wide, for all areas.';
$string['scalestandard_link'] = 'grade/scale';
$string['scalestip'] = 'To create custom scales, use the \'Scales...\' link in your area administration menu.';
$string['scalestip2'] = 'To create custom scales, click the Grades link in the area administration menu, then choose Edit, Scales.';
...
$string['searchcourses'] = 'Search areas';
...
$string['selectacourse'] = 'Select a area';
$string['selectacoursesite'] = 'Select a area or site';
...
$string['selectcoursesortby'] = 'Select how you would like to sort areas';
...
$string['share'] = 'Share';
$string['shortname'] = 'Short name'; /* @deprecated MDL-34652 - Use shortnamearea or shortnameuser or some own context specific string. */
$string['shortnamecollisionwarning'] = '[*] = This shortname is already in use by a area and will need to be changed upon approval';
$string['shortnamecourse'] = 'Area short name';
$string['shortnamecourse_help'] = 'The name displayed in areas with limited space. It must be unique.';
$string['shortnametaken'] = 'Short name is already used for another area ({$a})';
...
$string['showactivitydates_help'] = 'Show activity dates on the area page.';
$string['showadvancededitor'] = 'Advanced';
$string['showadvancedsettings'] = 'Show advanced settings';
$string['showall'] = 'Show all {$a}';
$string['showallcourses'] = 'Show all areas';
$string['showallusers'] = 'Show all users';
$string['showblockcourse'] = 'Show list of areas containing block';
...
$string['showdescription'] = 'Display description on area page';
$string['showdescription_help'] = 'If enabled, the description above will be displayed on the area page just below the link to the activity or resource.';
$string['showgrades'] = 'Show gradebook to employees';
$string['showgrades_help'] = 'Allow employees to view a list of all their grades in the area.';
$string['showingacourses'] = 'Showing all {$a} areas';
$string['showingxofycourses'] = 'Showing areas {$a->start} to {$a->end} of {$a->total} areas';
$string['showless'] = 'Show less';
$string['showlistofcourses'] = 'Show list of areas';
$string['showmodulecourse'] = 'Show list of areas containing activity';
$string['showmore'] = 'Show more';
$string['showoncoursepage'] = 'Show on area page';
...
$string['showreports_help'] = 'Allow employees to view their own activity reports via their profile page.';
...
$string['sitefilesused'] = 'Site files used in this area';
...
$string['sitepartlist'] = 'You do not have the required permissions to view the employees list';
$string['sitepartlist0'] = 'You must be a site teacher to be allowed to see the site employees list';
$string['sitepartlist1'] = 'You must be a teacher to be allowed to see the site employees list';
$string['sites'] = 'Sites';
...
$string['skiptocourselisting'] = 'Skip to the area listings';
$string['skiptocoursedetails'] = 'Skip to the detailed area information';
$string['socialheadline'] = 'Social forum - latest topics';
$string['someallowguest'] = 'Some areas may allow guest access';
...
$string['starpending'] = '([*] = area pending approval)';
$string['startdate'] = 'Area start date';
$string['startdate_help'] = 'This date determines the start of the first week for a area in weekly format. It is also the start date for logs of area activities.

If you reset the area and change this date, all dates in the area will be moved in relation to the new start date.';
$string['startdatewithtaskenabled'] = 'Area start date';
$string['startdatewithtaskenabled_help'] = 'The date when the area becomes visible to employees. Before this date, they will not be able to access the course.

This date also determines the start of the first week for a area in weekly format, and is the start date for logs of area activities. if you reset the area and change this date, all dates in the area will be moved in relation to the new start date.';
...
$string['statsnodata'] = 'There is no available data for that combination of area and time period.';
$string['statsnodatauser'] = 'There is no available data for that combination of area, user and time period.';
...
$string['statsreport11'] = 'Most active areas';
$string['statsreport12'] = 'Most active areas (weighted)';
$string['statsreport13'] = 'Most participatory areas (enrolments)';
$string['statsreport14'] = 'Most participatory areas (posts/views)';
...
$string['statsstudentactivity'] = 'Employee activity';
$string['statsstudentreads'] = 'Employee views';
$string['statsstudentwrites'] = 'Employee posts';
...
$string['studentnotallowed'] = 'Sorry, but you can not enter this area as \'{$a}\'';
$string['students'] = 'Employees';
$string['studentsandteachers'] = 'Employees and teachers';
...
$string['summary_help'] = 'The idea of a summary is a short text to prepare employees for the activities within the topic or week. The text is shown on the area page under the section name.';
...
$string['switchroleto_help'] = 'Choose a role to get an idea of how someone with that role will see this area.
...
$string['timesplitting:deciles_help'] = 'This analysis interval divides the area into tenths (10 equal parts), with each prediction being based on the data of only the most recent previous tenth.';
$string['timesplitting:decilesaccum'] = 'All previous tenths';
$string['timesplitting:decilesaccum_help'] = 'This analysis interval divides the area into tenths (10 equal parts), with each prediction being based on the accumulated data of all previous tenths.';
...
$string['timesplitting:quarters_help'] = 'This analysis interval divides the area into quarters (4 equal parts), with each prediction being based on the data of only the most recent previous quarter.';
$string['timesplitting:quartersaccum'] = 'All previous quarters';
$string['timesplitting:quartersaccum_help'] = 'This analysis interval divides the area into quarters (4 equal parts), with each prediction being based on the accumulated data of all previous quarters.';
$string['timesplitting:singlerange'] = 'From start to end';
$string['timesplitting:singlerange_help'] = 'This analysis interval considers the entire area as a single span.';
...
$string['timesplitting:tenpercentafterstart_help'] = 'This analysis interval generates a prediction after the 10% of the area is completed.';
$string['thanks'] = 'Thanks';
$string['theme'] = 'Theme';
$string['themes'] = 'Themes';
$string['themesaved'] = 'New theme saved';
$string['thereareno'] = 'There are no {$a} in this area';
$string['therearecourses'] = 'There are {$a} areas';
$string['thiscategory'] = 'This category';
$string['thiscategorycontains'] = 'This category contains';
$string['time'] = 'Time';
$string['timecreated'] = 'Time created';
$string['timecreatedcourse'] = 'Area time created';
...
$string['unexistingcmid'] = 'Area module ID not found';
$string['unexistingsectionid'] = 'Area section ID not found';
...
$string['updatethiscourse'] = 'Update this area';
...
$string['usingexistingcourse'] = 'Using existing area';
$string['validatehtml'] = 'Validate HTML';
$string['valuealreadyused'] = 'This value has already been used.';
$string['version'] = 'Version';
$string['view'] = 'View';
$string['viewing'] = 'Viewing:';
$string['viewallcourses'] = 'View all areas';
$string['viewallcoursescategories'] = 'View all areas and categories';
...
$string['visible_help'] = 'This setting determines whether the area appears in the list of areas. Apart from teachers and administrators, users are not allowed to enter the area.';
...
$string['wordforstudent'] = 'Your word for employee';
$string['wordforstudenteg'] = 'eg Employee, employee etc';
$string['wordforstudents'] = 'Your word for Employees';
$string['wordforstudentseg'] = 'eg Employees, employees etc';
...
$string['writingcoursedata'] = 'Writing area data';
...
$string['youneedtoenrol'] = 'To perform that action you need to enrol in this area.';
