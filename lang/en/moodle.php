...
$string['adminhelpassignstudents'] = 'Go into a area and add students from the admin menu';
...
$string['courseavailable'] = 'This area is available to students';
$string['courseavailablenot'] = 'This area is not available to students';
...
$string['coursehelpcategory'] = 'Position the area on the area listing and may make it easier for students to find it.';
...
$string['coursehelphiddensections'] = 'How the hidden sections in the area are displayed to students.';
...
$string['coursehidden'] = 'This area is currently unavailable to students';
...
$string['coursevisibility_help'] = '* Show: The area appears in the list of areas and students can access it.
...
$string['defaultcoursestudentdescription'] = 'Students generally have fewer privileges within a area.';
...
$string['defaultcourseteacherdescription'] = 'Teachers can do anything within a area, including changing the activities and grading students.';
...
$string['enddate_help'] = 'The end date doesn’t restrict student access to the area. It determines whether a area is listed as Past in My areas.';
$string['enddatewithtaskenabled'] = 'Area end date';
$string['enddatewithtaskenabled_help'] = 'The date when the area becomes hidden for students and they can no longer access it.';
...
$string['hiddensections_help'] = 'Hidden sections can be displayed to students as \'not available\' on the area page, or kept completely hidden.';
...
$string['indicator:accessesafterend_help'] = 'This indicator reflects if the student accessed the area after the area end date.';
$string['indicator:accessesbeforestart'] = 'Area accessed before start date';
$string['indicator:accessesbeforestart_help'] = 'This indicator reflects if the student accessed the area before the area start date.';
...
$string['indicator:anywriteincourse_help'] = 'This indicator represents any write (submit) action taken by the student in any area activity.';
...
$string['indicator:nostudent_help'] = 'This indicator reflects the availability of students in the area.';
...
$string['indicator:potentialcognitive_help'] = 'This indicator is based on the potential cognitive depth that could be reached by a student participating in area activities.';
...
$string['indicator:potentialsocial_help'] = 'This indicator is based on the potential social breadth that could be reached by the student participating in area activities.';
...
$string['maximumupload_help'] = 'The maximum file size allowed for student uploads to the area. Additionally, you can further restrict the maximum upload size for each activity.';
...
$string['modvisible_help'] = '* Show on area page: Available to students (subject to any access restrictions which may be set).
* Hide on area page: Not available to students.';
$string['modvisiblewithstealth'] = 'Availability';
$string['modvisiblewithstealth_help'] = '* Show on area page: Available to students (subject to any access restrictions which may be set).
* Hide on area page: Not available to students.
* Make available but don\'t show on area page: Available to students if you provide a link. Activities will still appear in the gradebook and other reports.';
$string['modvisiblehiddensection'] = 'Availability';
$string['modvisiblehiddensection_help'] = '* Hide on area page: Not available to students.
* Make available but don\'t show on area page: Available to students if you provide a link. Activities will still appear in the gradebook and other reports.';
...
$string['noneditingteacherdescription'] = 'Non-editing teachers can teach in areas and grade students, but may not alter activities.';
...
$string['nostudentsyet'] = 'There are no students enrolled in this area.';
...
$string['noteachingupcomingcourses'] = 'Upcoming areas have no teachers or students';
...
$string['showgrades_help'] = 'Allow students to view a list of all their grades in the area.';
...
$string['startdatewithtaskenabled_help'] = 'The date when the area becomes visible to students. Before this date, they will not be able to access the course.
...
$string['summary_help'] = 'The idea of a summary is a short text to prepare students for the activities within the topic or week. The text is shown on the area page under the section name.';
...
$string['wordforstudenteg'] = 'eg Student, employee etc';
$string['wordforstudents'] = 'Your word for Students';
$string['wordforstudentseg'] = 'eg Students, employees etc';
