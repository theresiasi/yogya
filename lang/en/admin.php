...
$string['allowcoursethemes'] = 'Allow area themes';
...
$string['backup_shortname'] = 'Use area name in backup filename';
$string['backup_shortnamehelp'] = 'Use the area name as part of the backup filename.';
...
$string['blockprotect_help'] = 'If you lock a particular type of block, then no-one will be able to add or delete instances. (You can, of area, unlock again if you need to edit instances.)
...
$string['calendartype_desc'] = 'Choose a default calendar type for the whole site. This setting can be overridden in the area settings or by users in their personal profile.';
...
$string['configallowcategorythemes'] = 'If you enable this, then themes can be set at the category level. This will affect all child categories and areas unless they have specifically set their own theme. WARNING: Enabling category themes may affect performance.';
...
$string['configallowcoursethemes'] = 'If enabled, then areas will be allowed to set their own themes.  area themes override all other theme choices (site, user, category, cohort or URL-defined themes).';
...
$string['configallowthemechangeonurl'] = 'If enabled, the theme can be changed by adding either:<br />?theme=themename to any Moodle URL (eg: mymoodlesite.com/?theme=afterburner ) or <br />&theme=themename to any internal Moodle URL (eg: mymoodlesite.com/area/view.php?id=2&theme=afterburner ).';
...
$string['configautologinguests'] = 'Should visitors be logged in as guests automatically when entering areas with guest access?';
...
$string['configcoursegraceperiodafter'] = 'Classify past areas as in progress for these many days after the area end date.';
$string['configcoursegraceperiodbefore'] = 'Classify future areas as in progress for these many days prior to the area start date.';
$string['configcourseoverviewfilesext'] = 'A comma-separated list of allowed area image file extensions.';
$string['configcourseoverviewfileslimit'] = 'The maximum number of files that can be displayed next to the area summary on the list of areas page. The first image file added is used as the area image in the area overview on users\' Dashboards; any additional files are displayed on the list of areas page only.';
$string['configcourserequestnotify'] = 'Type username of user to be notified when new area requested.';
$string['configcourserequestnotify2'] = 'Users who will be notified when a area is requested. Only users who can approve area requests are listed here.';
$string['configcoursesperpage'] = 'Enter the number of areas to be displayed per page in a area listing.';
$string['configcourseswithsummarieslimit'] = 'The maximum number of areas to display in a area listing including summaries before falling back to a simpler listing.';
...
$string['configdefaultrequestcategory'] = 'areas requested by users with the capability to request new areas in the system context will be placed in this category unless users are able to select a different category.';
$string['configdefaultrequestedcategory'] = 'Default category to put areas that were requested into, if they\'re approved.';
$string['configdefaultuserroleid'] = 'All logged in users will be given the capabilities of the role you specify here, at the site level, in ADDITION to any other roles they may have been given.  The default is the Authenticated user role.  Note that this will not conflict with other roles they have unless you prohibit capabilities, it just ensures that all users have capabilities that are not assignable at the area level (eg post blog entries, manage own calendar, etc).';
...
$string['configenablecourserequests'] = 'If enabled, users with the capability to request new areas (moodle/course:request) will have the option to request a area. This capability is not allowed for any of the default roles. It may be applied in the system or category context.';
...
$string['configenablestats'] = 'If you choose \'yes\' here, Moodle\'s cronjob will process the logs and gather some statistics.  Depending on the amount of traffic on your site, this can take awhile. If you enable this, you will be able to see some interesting graphs and statistics about each of your areas, or on a sitewide basis.';
...
$string['configfilternavigationwithsystemcontext'] = 'Normal use of the filtering is tied to the context in which it is used (e.g. area context), but for the site navigation, explicitly making everything filter with site context can yield performance improvements when using "content and headings" filtering.';
...
$string['configforcelogin'] = 'Normally, the site home and the area listings (but not areas) can be read by people without logging in to the site. If you want to force people to log in before they do ANYTHING on the site, then you should enable this setting.';
...
$string['configfrontpagecourselimit'] = 'Maximum number of areas';
$string['configfrontpagecourselimithelp'] = 'Maximum number of areas to be displayed on the site home in area listings.';
...
$string['configgradebookroles'] = 'This setting allows you to control who appears on the gradebook.  Users need to have at least one of these roles in a area to be shown in the gradebook for that area.';
...
$string['confighiddenuserfields'] = 'Select which user information fields you wish to hide from other users other than area teachers/admins. This will increase student privacy. Hold CTRL key to select multiple fields.';
...
$string['configlockrequestcategory'] = 'If enabled, users with the capability to request new areas in the system context will not be able to select a category in the request a new area form. An alternative way of restricting users to requesting a new area in just one category is to apply the capability to request new areas in the category context.';
...
$string['configmaxbytes'] = 'This specifies a maximum size for files uploaded to the site. This setting is limited by the PHP settings post_max_size and upload_max_filesize, as well as the Apache setting LimitRequestBody. In turn, maxbytes limits the range of sizes that can be chosen at area or activity level. If \'Site upload limit\' is chosen, the maximum size allowed by the server will be used.';
...
$string['configmycoursesperpage'] = 'Maximum number of areas to display in any list of a user\'s own areas';
...
$string['confignavcourselimit'] = 'Limits the number of areas shown to the user in the navigation.';
$string['confignavshowallcourses'] = 'This setting determines whether users who are enrolled in areas can see areas (listing all areas) in the navigation, in addition to My areas (listing areas in which they are enrolled).';
$string['confignavshowcategories'] = 'Show area categories in the navigation bar and navigation blocks. This does not occur with areas the user is currently enrolled in; they will still be listed under My areas without categories.';
...
$string['configprofileroles'] = 'Roles that are listed in user profiles and on the employees page.';
$string['configprofilesforenrolledusersonly'] = 'To prevent misuse by spammers, profile descriptions of users who are not yet enrolled in any area are hidden. New users must enrol in at least one area before they can add a profile description.';
...
$string['configsectionrequestedcourse'] = 'area requests';
...
$string['configstatsuserthreshold'] = 'This setting specifies the minimum number of enrolled users for a area to be included in statistics calculations.';
...
$string['configuseblogassociations'] = 'Should users be able to organize their blog by associating entries with areas and area modules?';
...
$string['configvisiblecourses'] = 'Display areas in hidden categories normally';
...
$string['contextlocking_desc'] = 'This setting enables read-only access to be set for selected categories, areas, activities or blocks.';
...
$string['course_customfield'] = 'area custom fields';
$string['coursecolor'] = 'Colour {$a}';
$string['coursecolorheading_desc'] = 'Any areas without a area image set in the area settings are displayed on the Dashboard with a patterned area card. The colours used in the pattern may be specified below.';
$string['coursecolorsettings'] = 'area card colours';
$string['coursecontact'] = 'area contacts';
$string['coursecontact_desc'] = 'This setting allows you to control who appears on the area description. Users need to have at least one of these roles in a area to be shown on the area description for that area.';
$string['coursecontactduplicates'] = 'Display all area contact roles';
$string['coursecontactduplicates_desc'] = 'If enabled, users with more than one of the selected area contact roles will be displayed in the area description with each of their roles. Otherwise, they will be displayed with only one role (whichever is listed highest in \'Define roles\' in the Site administration).';
$string['coursegraceperiodafter'] = 'Grace period for past areas';
$string['coursegraceperiodbefore'] = 'Grace period for future areas';
$string['courselistshortnames'] = 'Display extended area names';
$string['courselistshortnames_desc'] = 'If enabled, area short names will be displayed in addition to full names in area lists. If required, extended area names may be customised by editing the \'courseextendednamedisplay\' language string using the language customisation feature.';
$string['coursemgmt'] = 'Manage areas and categories';
$string['courseoverview'] = 'area overview';
$string['courserequestnotify'] = 'area request notification';
$string['courserequestnotifyemail'] = '{$a->user} requested a new area <a href="{$a->link}">{$a->link}</a>';
$string['courserequests'] = 'area requests';
$string['courserequestspending'] = 'Pending area requests';
$string['courses'] = 'areas';
$string['coursesperpage'] = 'areas per page';
$string['courseswithsummarieslimit'] = 'areas with summaries limit';
$string['creatornewroleid'] = 'Creators\' role in new areas';
$string['creatornewroleid_help'] = 'If the user does not already have the permission to manage the new area, the user is automatically enrolled using this role.';
$string['cron'] = 'Cron';
...
$string['defaultformatnotset'] = 'Error determining default area format. Please check site settings.';
$string['defaulthomepage'] = 'Start page for users';
$string['defaultrequestcategory'] = 'Default category for area requests';
...
$string['coursecreationguide'] = 'Moodle area creation guide URL';
$string['coursecreationguide_help'] = 'Defines the path to a Quickstart guide with short videos and general tips to create areas. A link to the guide is displayed on the My areas page when there are no areas to show. Only users with the capability to create areas will see the link.';
...
$string['downloadcoursecontentallowed'] = 'Download area content feature available';
$string['downloadcoursecontentallowed_desc'] = 'Whether the download area content feature is available to areas. When available, area content downloads can be enabled/disabled using the "Enable download area content" setting within the area edit menu (the default for this can be set in <a href={$a} target="_blank">area default settings</a>).';
...
$string['enablepdfexportfont_desc'] = 'If your site has areas in different languages which need other fonts in generated PDF files, you can provide the option to set the font in the area settings. You need to specify available fonts in $CFG->pdfexportfont in config.php.';
...
$string['enablesharingtomoodlenet_desc'] = 'Enable users to share area content to a configured MoodleNet instance if they have the relevant capability.';
...
$string['enroladminnewcourse'] = 'Auto-enrol admin in new areas';
$string['enroladminnewcourse_help'] = 'When an admin adds a new area, should they be automatically enrolled and assigned the creators\' role in new areas?';
$string['enrolinstancedefaults'] = 'Enrolment instance defaults';
$string['enrolinstancedefaults_desc'] = 'Default enrolment settings in new areas.';
...
$string['filescleanupperiod_help'] = 'How often trash pool files are deleted. These are files that are associated with a context that no longer exists, for example when a area is deleted. Please note: This setting can result in missing files in a area which is backed up, deleted and then restored if the setting \'Include files\' (backup_auto_files) in \'Automated backup settings\' is disabled.';
...
$string['formatuninstallwithcourses'] = 'There are {$a->count} areas using {$a->format}. Their format will be changed to {$a->defaultformat} (default format for this site). Some format-specific data may be lost. Are you sure you want to proceed?';
...
$string['guestroleid_help'] = 'This role is automatically assigned to the guest user. It is also temporarily assigned to not enrolled users that enter the area via guest enrolment plugin.';
$string['helpadminseesall'] = 'In the site calendar, do admins see and filter events from all area calendars or just those from areas they are enrolled in? Regardless of the chosen option, admins will always be able to manage events for each area calendar by navigating to the area first, and then accessing the area calendar directly.';
...
$string['legacyfilesaddallowed'] = 'Allow adding to legacy area files';
$string['legacyfilesaddallowed_help'] = 'If a area has legacy area files, allow new files and folders to be added to it.';
$string['legacyfilesinnewcourses'] = 'Legacy area files in new areas';
$string['legacyfilesinnewcourses_help'] = 'By default, legacy area files areas are available in upgraded areas only. Please note that some features such as activity backup and restore are not compatible with this setting.';
...
$string['linkcoursesections'] = 'Always link area sections';
$string['linkcoursesections_help'] = 'Always try to provide a link for area sections. area sections are usually only shown as links if the area format displays a single section per page. If this setting is enabled a link will always be provided.';
...
$string['manageformats'] = 'Manage area formats';
...
$string['maxsizeperdownloadcoursefile_desc'] = 'The maximum size of each file when downloading area content. Files exceeding this size will be omitted from the download.';
$string['maxeditingtime'] = 'Maximum time to edit posts';
$string['maxusersperpage'] = ' Maximum users per page';
$string['configmaxusersperpage'] = 'Maximum number of users displayed within user selector in area, group, cohort, webservice etc.';
...
$string['mnetrestore_extusers_noadmin'] = '<strong>Note:</strong> This backup file seems to come from a different Moodle installation and contains remote Moodle Network user accounts. You are not allowed to execute this type of restore. Contact the administrator of the site or, alternatively, restore this area without any user information (modules, files...)';
...
$string['mycoursesperpage'] = 'Number of areas';
...
$string['navadduserpostslinks_help'] = 'If enabled two links will be added to each user in the navigation to view discussions the user has started and posts the user has made in forums throughout the site or in specific areas.';
$string['navigationupgrade'] = 'This upgrade introduces two new navigation blocks that will replace these blocks: Administration, areas, Activities and Employees.  If you had set any special permissions on those blocks you should check to make sure everything is behaving as you want it.';
$string['navcourselimit'] = 'area limit';
$string['navshowfullcoursenames'] = 'Show area full names';
$string['navshowfullcoursenames_help'] = 'If enabled, area full names will be used in the navigation rather than short names.';
...
$string['navshowallcourses'] = 'Show all areas';
$string['navshowcategories'] = 'Show area categories';
$string['navshowmycoursecategories'] = 'Show my area categories';
$string['navshowmycoursecategories_help'] = 'If enabled, areas in the user\'s My areas branch will be shown in categories in the navigation block (Classic-based themes only).';
$string['navsortmycourseshiddenlast'] = 'Sort my hidden areas last';
$string['navsortmycourseshiddenlast_help'] = 'If enabled, any hidden areas will be listed after visible areas (for users who can view hidden areas). Otherwise, all areas, regardless of their visibility, will be listed according to the \'Sort my areas\' setting.';
$string['navsortmycoursessort'] = 'Order of areas in navigation block';
$string['navsortmycoursessort_help'] = 'Should areas be listed in the sort order set in Site administration > areas > Manage areas and categories, or alphabetically by area setting? This setting only applies to themes based on Classic.';
$string['never'] = 'Never';
...
$string['noteunneededblocks'] = 'Note: Blocks set to show will not be listed in the \'Add a block\' menu in a area if they are specified in the theme setting \'Unneeded blocks\'.';
...
$string['moodleapp_help'] = '<p>The free Moodle app enables users to access their areas on mobile devices. Additional app features are available with a Pro or Premium app plan.</p>
...
* Visible to user, teachers and admins - For private data only viewable by the user, administrators and teachers (on area profile)
* Visible to everyone';
...
$string['profilingincluded_help'] = 'List of (comma or newline separated, absolute skipping wwwroot, callable) URLs that will be automatically profiled. Examples: /index.php, /area/view.php. Also accepts the * wildchar at any position. Examples: /mod/forum/*, /mod/*/view.php.';
...
$string['replacefrontsearch'] = 'Used for site home area search';
...
$string['resetindentation_help'] = 'This will remove any indentation previously set for all areas on the site in {$a->format}.';
$string['resetindentation'] = 'Reset indentation sitewide';
$string['resetindentationsuccess'] = 'Indentation reset.';
$string['restorecourse'] = 'Restore area';
$string['restorernewroleid'] = 'Restorers\' role in areas';
$string['restorernewroleid_help'] = 'If the user does not already have the permission to manage the newly restored area, the user is automatically assigned this role and enrolled if necessary. Select "None" if you do not want restorers to be able to manage every restored area.';
...
$string['searchablecourses'] = 'Searchable areas';
$string['searchallavailablecourses'] = 'Searchable areas';
$string['searchallavailablecourses_off'] = 'Search within enrolled areas only';
$string['searchallavailablecourses_on'] = 'Search within all areas the user can access';
$string['searchallavailablecourses_desc'] = 'In some situations the search engine may not work when searching across a large number of areas. Set to search only enrolled areas if you need to restrict the number of areas searched.';
...
$string['searchmaxtopresults_desc'] = 'The maximum number of highest-ranked results to be displayed above the search results for area content, areas and users.';
...
$string['searchallavailablecoursesdesc'] = 'If set to search within enrolled areas only, area information (name and summary) and area content will only be searched in areas which the user is enrolled in. Otherwise, area information and area content will be searched in all areas which the user can access, such as areas with guest access enabled.';
$string['searchincludeallcourses'] = 'Include all visible areas';
$string['searchincludeallcourses_desc'] = 'If enabled, search results will include area information (name and summary) of areas which are visible to the user, even if they don\'t have access to the area content.';
...
$string['sort_fullname'] = 'area full name';
$string['sort_idnumber'] = 'area ID number';
$string['sort_shortname'] = 'area short name';
...
$string['stickyblockscourseview'] = 'area page';
